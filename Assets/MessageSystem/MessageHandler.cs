...
public static class MessageHandler 
{
	...
	{
		PrintMessage(list, message, messageTime,  messageColor, messageMargin);
	}
	...
	private static void PrintMessage(string list, string message, int? messageTime, Color? messageColor = null, int? margin = null, Color? fontColor = null, int? fontSize = null, FontStyle? style = null, TextAnchor? anchor = null)
	{
		try{
